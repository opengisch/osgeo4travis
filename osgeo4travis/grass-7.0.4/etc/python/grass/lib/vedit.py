...
Generated with:
./ctypesgen.py --cpp clang-3.6 -E       -I/usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include -I/usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include -D__GLIBC_HAVE_LONG_LONG -lgrass_vedit.7.0.4 -I/home/travis/osgeo4travis/include -I/home/travis/osgeo4travis/include /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h -o OBJ.x86_64-pc-linux-gnu/vedit.py
...
_libs["grass_vedit.7.0.4"] = load_library("grass_vedit.7.0.4")
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h: 45
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h: 50
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h: 58
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 5
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_split_lines'):
    Vedit_split_lines = _libs['grass_vedit.7.0.4'].Vedit_split_lines
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 7
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_connect_lines'):
    Vedit_connect_lines = _libs['grass_vedit.7.0.4'].Vedit_connect_lines
    Vedit_connect_lines.restype = c_int
    Vedit_connect_lines.argtypes = [POINTER(struct_Map_info), POINTER(struct_ilist), c_double]

# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 10
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_modify_cats'):
    Vedit_modify_cats = _libs['grass_vedit.7.0.4'].Vedit_modify_cats
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 14
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_copy_lines'):
    Vedit_copy_lines = _libs['grass_vedit.7.0.4'].Vedit_copy_lines
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 17
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_chtype_lines'):
    Vedit_chtype_lines = _libs['grass_vedit.7.0.4'].Vedit_chtype_lines
    Vedit_chtype_lines.restype = c_int
    Vedit_chtype_lines.argtypes = [POINTER(struct_Map_info), POINTER(struct_ilist)]

# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 20
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_delete_lines'):
    Vedit_delete_lines = _libs['grass_vedit.7.0.4'].Vedit_delete_lines
    Vedit_delete_lines.restype = c_int
    Vedit_delete_lines.argtypes = [POINTER(struct_Map_info), POINTER(struct_ilist)]

# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 21
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_delete_area_centroid'):
    Vedit_delete_area_centroid = _libs['grass_vedit.7.0.4'].Vedit_delete_area_centroid
    Vedit_delete_area_centroid.restype = c_int
    Vedit_delete_area_centroid.argtypes = [POINTER(struct_Map_info), c_int]

# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 22
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_delete_area'):
    Vedit_delete_area = _libs['grass_vedit.7.0.4'].Vedit_delete_area
    Vedit_delete_area.restype = c_int
    Vedit_delete_area.argtypes = [POINTER(struct_Map_info), c_int]

# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 23
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_delete_areas_cat'):
    Vedit_delete_areas_cat = _libs['grass_vedit.7.0.4'].Vedit_delete_areas_cat
    Vedit_delete_areas_cat.restype = c_int
    Vedit_delete_areas_cat.argtypes = [POINTER(struct_Map_info), c_int, c_int]

# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 26
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_get_min_distance'):
    Vedit_get_min_distance = _libs['grass_vedit.7.0.4'].Vedit_get_min_distance
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 30
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_flip_lines'):
    Vedit_flip_lines = _libs['grass_vedit.7.0.4'].Vedit_flip_lines
    Vedit_flip_lines.restype = c_int
    Vedit_flip_lines.argtypes = [POINTER(struct_Map_info), POINTER(struct_ilist)]

# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 33
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_merge_lines'):
    Vedit_merge_lines = _libs['grass_vedit.7.0.4'].Vedit_merge_lines
    Vedit_merge_lines.restype = c_int
    Vedit_merge_lines.argtypes = [POINTER(struct_Map_info), POINTER(struct_ilist)]

# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 36
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_move_lines'):
    Vedit_move_lines = _libs['grass_vedit.7.0.4'].Vedit_move_lines
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 40
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_render_map'):
    Vedit_render_map = _libs['grass_vedit.7.0.4'].Vedit_render_map
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 44
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_select_by_query'):
    Vedit_select_by_query = _libs['grass_vedit.7.0.4'].Vedit_select_by_query
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 48
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_snap_point'):
    Vedit_snap_point = _libs['grass_vedit.7.0.4'].Vedit_snap_point
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 50
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_snap_line'):
    Vedit_snap_line = _libs['grass_vedit.7.0.4'].Vedit_snap_line
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 52
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_snap_lines'):
    Vedit_snap_lines = _libs['grass_vedit.7.0.4'].Vedit_snap_lines
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 56
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_move_vertex'):
    Vedit_move_vertex = _libs['grass_vedit.7.0.4'].Vedit_move_vertex
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 60
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_add_vertex'):
    Vedit_add_vertex = _libs['grass_vedit.7.0.4'].Vedit_add_vertex
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 62
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_remove_vertex'):
    Vedit_remove_vertex = _libs['grass_vedit.7.0.4'].Vedit_remove_vertex
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/defs/vedit.h: 66
if hasattr(_libs['grass_vedit.7.0.4'], 'Vedit_bulk_labeling'):
    Vedit_bulk_labeling = _libs['grass_vedit.7.0.4'].Vedit_bulk_labeling
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h: 7
try:
    NO_SNAP = 0
except:
    pass
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h: 8
try:
    QUERY_UNKNOWN = (-1)
except:
    pass
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h: 10
try:
    TYPE_POINT = 1
except:
    pass
...
# /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h: 11
try:
    DRAW_POINT = 1
except:
    pass
...
rpoint = struct_rpoint # /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h: 45

robject = struct_robject # /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h: 50

robject_list = struct_robject_list # /usr/src/grass-7.0.4/dist.x86_64-pc-linux-gnu/include/grass/vedit.h: 58
