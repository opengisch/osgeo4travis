...
set_target_properties(qt5keychain PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG "Qt5::Core;Qt5::DBus"
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libqt5keychain.so.0.7.0"
  IMPORTED_SONAME_NOCONFIG "libqt5keychain.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS qt5keychain )
list(APPEND _IMPORT_CHECK_FILES_FOR_qt5keychain "${_IMPORT_PREFIX}/lib/x86_64-linux-gnu/libqt5keychain.so.0.7.0" )
